...
module assemblyFrameBasement(px=0, py=0, pz=0, rx=0, ry=0, rz=0){
    translate([(px), (py), pz])
    rotate([rx,ry,rz]){
        moFrameVertexFootR2off(143.5,200,0, 90,0,90);
        moFrameVertexFootL2off(143.5,-200,0,90,0,90);
...
module assemblyFrameTriangle(px=0, py=0, pz=0, rx=0, ry=0, rz=0){
    translate([(px), (py), pz])
    rotate([rx,ry,rz]){
        moFrameVertex2off(px=145, pz=350, rx=90, ry=90, rz=90);        
        m8Rod(370, px=150, py=100, pz=190, rx=30);
        m8Rod(370, px=150, py=-100, pz=190, rx=-30);
